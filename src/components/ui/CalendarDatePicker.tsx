...
export function CalendarDatePicker({ startDate, endDate, onDateChange, className = "" }: CalendarDatePickerProps) {
  ...
  return (
    <div className={`relative ${className}`} ref={popoverRef}>
      <button
        ...
        className="flex items-center gap-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-2 text-xs font-bold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 outline-none focus:border-indigo-500 transition-all shadow-sm group"
      >
