...
const authenticateAsOwner = async (page: Page) => {
  ...
  await page.getByPlaceholder('dev.patel@esscompany.com').pressSequentially('owner@test.com', { delay: 10 });
...
test.describe('OWNER E2E Access', () => {
  ...
  const routes = [
    { url: '/ess-crm/owner', text: 'Executive Dashboard' },
    { url: '/ess-crm/finance', text: 'Total Contracted Revenue' },
    { url: '/ess-crm/employees', text: 'Team Members' }, // Adjust if text is different
    { url: '/ess-crm/leads', text: 'Sales CRM' },
    { url: '/ess-crm/clients', text: 'Client Directory' }, // Adjust
    { url: '/ess-crm/projects', text: 'Active Projects' }, // Adjust
    { url: '/ess-crm/attendance', text: 'ESS Work Clock' },
    { url: '/ess-crm/audit', text: 'Audit' } // Adjust
  ];
